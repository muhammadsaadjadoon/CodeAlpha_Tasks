...
<a href="./docs/screenshots/01-landing-dark.png">
  <img src="./docs/screenshots/01-landing-dark.png" alt="Credora landing screen" width="100%">
</a>

<p align="center"><sub><strong>Credora:</strong> an enterprise-style credit-risk workspace that connects model training, applicant scoring, analytics, persistence and assessment review in one interface.</sub></p>
