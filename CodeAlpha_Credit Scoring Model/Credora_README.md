...
<sub><strong>Live scoring · model validation · explainable assessment · persistent review</strong></sub>
  ...
  <tr>
    <td width="68%" rowspan="2" valign="top">
      <a href="./docs/screenshots/11-model-analytics-logistic-regression.png">
        <img src="./docs/screenshots/11-model-analytics-logistic-regression.png" alt="Credora model analytics workspace" width="100%">
      </a>
      <br>
      <sub><strong>MODEL INTELLIGENCE</strong> — validation metrics, confusion matrix, ROC evidence and feature importance exposed inside the product.</sub>
    </td>
    <td width="32%" valign="top">
      <a href="./docs/screenshots/09-prediction-result.png">
        <img src="./docs/screenshots/09-prediction-result.png" alt="Credora explainable credit assessment result" width="100%">
      </a>
      <br>
      <sub><strong>EXPLAINABLE ASSESSMENT</strong> — score, risk level, probability, confidence, recommendation and business-facing factors.</sub>
    </td>
  </tr>
  <tr>
    <td width="32%" valign="top">
      <a href="./docs/screenshots/01-landing-dark.png">
        <img src="./docs/screenshots/01-landing-dark.png" alt="Credora secure product entry" width="100%">
      </a>
      <br>
      <sub><strong>SECURE WORKSPACE</strong> — account access, backend-saved records and a complete credit-risk workflow from one entry point.</sub>
    </td>
  </tr>
</table>

<p align="center"><sub><strong>Credora:</strong> a portfolio-grade full-stack ML system connecting model training, live applicant scoring, analytics, persistence and review.</sub></p>
...
> All screenshots below use repository-relative paths. Click any screenshot on GitHub to open the original image.

## 1. Product Entry and Account Access

Credora begins with a focused product landing page instead of dropping the user directly into a form.

<a href="./docs/screenshots/01-landing-dark.png">
  <img src="./docs/screenshots/01-landing-dark.png" alt="Credora landing page" width="100%">
</a>

<p align="center"><sub><strong>Landing Experience:</strong> product positioning, secure-account messaging, backend-saved records and model-evaluation positioning.</sub></p>
...
<br><sub><strong>Sign In:</strong> authenticated access through email/password credentials and a backend session.</sub>
</td>
<td width="50%" valign="top">
...
<br><sub><strong>Create Account:</strong> full name, email and password onboarding.</sub>
</td>
</tr>
</table>
...
The overview is driven by saved assessment data rather than static demonstration numbers. A new workspace starts empty and populates as real assessments are saved.

<table>
<tr>
<td width="50%" valign="top">
<a href="./docs/screenshots/04-overview-dark-empty.png"><img src="./docs/screenshots/04-overview-dark-empty.png" alt="Credora empty dashboard dark theme" width="100%"></a>
<br><sub><strong>Fresh Workspace:</strong> zero-state totals, risk bands, score distribution and weekly assessment trend.</sub>
</td>
<td width="50%" valign="top">
...
<br><sub><strong>Populated Workspace:</strong> saved assessments immediately update operational metrics.</sub>
</td>
</tr>
</table>
...
## 3. Live Credit Assessment

The scoring interface separates inputs into clear applicant, financial, loan and credit sections.
...
<p align="center"><sub><strong>Applicant Information:</strong> identity, age, gender and employment inputs begin the assessment workflow.</sub></p>
...
<br><sub><strong>Financial + Loan Profile:</strong> income, debt, expenses, savings, requested amount, term and purpose.</sub>
</td>
<td width="50%" valign="top">
<a href="./docs/screenshots/08-live-scoring-credit-submit.png"><img src="./docs/screenshots/08-live-scoring-credit-submit.png" alt="Credora credit information and submit" width="100%"></a>
<br><sub><strong>Credit Profile:</strong> history length, defaults, late payments, utilization, balances and payment behaviour.</sub>
</td>
</tr>
</table>
...
## 4. Prediction Result and Assessment Report

The model output is presented as more than a class label.

<a href="./docs/screenshots/09-prediction-result.png">
  <img src="./docs/screenshots/09-prediction-result.png" alt="Credora credit prediction result" width="100%">
</a>

<p align="center"><sub><strong>Assessment Result:</strong> credit score, risk level, model probability, confidence, recommendation, active model/version, positive factors, risk factors and improvement suggestions.</sub></p>

<a href="./docs/screenshots/10-assessment-report.png">
  <img src="./docs/screenshots/10-assessment-report.png" alt="Credora printable credit assessment report" width="100%">
</a>

<p align="center"><sub><strong>Printable Report:</strong> a clean browser-rendered record with assessment reference, factors, model identity and a responsible-use disclaimer.</sub></p>

---

## 5. Model Analytics

Credora makes validation evidence visible inside the product instead of hiding it in training logs.

<table>
<tr>
<td width="33%" valign="top">
<a href="./docs/screenshots/11-model-analytics-logistic-regression.png"><img src="./docs/screenshots/11-model-analytics-logistic-regression.png" alt="Logistic Regression analytics" width="100%"></a>
<br><sub><strong>Logistic Regression</strong></sub>
</td>
<td width="33%" valign="top">
<a href="./docs/screenshots/12-model-analytics-random-forest.png"><img src="./docs/screenshots/12-model-analytics-random-forest.png" alt="Random Forest analytics" width="100%"></a>
<br><sub><strong>Random Forest</strong></sub>
</td>
<td width="33%" valign="top">
<a href="./docs/screenshots/13-model-analytics-decision-tree.png"><img src="./docs/screenshots/13-model-analytics-decision-tree.png" alt="Decision Tree analytics" width="100%"></a>
<br><sub><strong>Decision Tree</strong></sub>
</td>
</tr>
</table>

<a href="./docs/screenshots/14-model-comparison.png">
  <img src="./docs/screenshots/14-model-comparison.png" alt="Credora model comparison table" width="100%">
</a>

<p align="center"><sub><strong>Model Comparison:</strong> Accuracy, Precision, Recall, F1 and ROC-AUC are evaluated side-by-side before the training pipeline selects its active artifact.</sub></p>

---

## 6. Dataset Insights and Quality

The Insights workspace surfaces dataset-level evidence used by the training system.

<table>
<tr>
<td width="50%" valign="top">
<a href="./docs/screenshots/15-insights-dark.png"><img src="./docs/screenshots/15-insights-dark.png" alt="Credora insights dark theme" width="100%"></a>
<br><sub><strong>Dark Insights:</strong> record count, feature count, missing values, duplicates and distribution summaries.</sub>
</td>
<td width="50%" valign="top">
<a href="./docs/screenshots/19-insights-light.png"><img src="./docs/screenshots/19-insights-light.png" alt="Credora insights light theme" width="100%"></a>
<br><sub><strong>Light Insights:</strong> the same analytical evidence in the alternate workspace theme.</sub>
</td>
</tr>
</table>
...
## 7. Applicant and Assessment Records

Applicant identity and assessment evidence remain connected through backend relationships.

<table>
<tr>
<td width="50%" valign="top">
<a href="./docs/screenshots/16-applicants-dark.png"><img src="./docs/screenshots/16-applicants-dark.png" alt="Credora applicants page" width="100%"></a>
<br><sub><strong>Applicant Records:</strong> searchable applicants with income, latest score, current risk level and last assessment.</sub>
</td>
<td width="50%" valign="top">
<a href="./docs/screenshots/17-assessment-history-dark.png"><img src="./docs/screenshots/17-assessment-history-dark.png" alt="Credora assessment history" width="100%"></a>
<br><sub><strong>Assessment History:</strong> saved references, scores, recommendations, model identity, view/delete actions and CSV export.</sub>
</td>
</tr>
</table>
...
## 8. Account, Application and Security Settings

<a href="./docs/screenshots/18-settings-light.png">
  <img src="./docs/screenshots/18-settings-light.png" alt="Credora settings page light theme" width="100%">
</a>

<p align="center"><sub><strong>Settings Workspace:</strong> profile image, account details, theme, preferred language, prediction threshold, auto-save/alerts and password management.</sub></p>
...
Machine Learning / Full-Stack AI Project
